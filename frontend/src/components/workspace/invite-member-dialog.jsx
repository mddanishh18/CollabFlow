...
/**
 * Reusable invite member dialog component
 * @param {boolean} open - Dialog open state
 * @param {function} onOpenChange - Dialog state change handler
 * @param {string} workspaceId - Workspace ID to invite to
 * @param {function} onSuccess - Callback after successful invite
 */
export function InviteMemberDialog({ open, onOpenChange, workspaceId, onSuccess }) {

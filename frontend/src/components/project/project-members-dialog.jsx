...
export function ProjectMembersDialog({
    ...
    const allMembers = [
        ...
        ...(project?.members?.filter(m =>
            (m.user?._id || m.user) !== (project?.owner?._id || project?.owner)
        ) || [])
    ];
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <Avatar className="h-10 w-10">
                                                <AvatarFallback className={`text-sm ${member.isOwner
            ...
            <AlertDialog open={confirmRemoveOpen} onOpenChange={setConfirmRemoveOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Are you sure you want to remove <strong>{selectedMember?.user?.name}</strong> from this project?

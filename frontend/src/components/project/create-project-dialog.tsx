...
import { FolderKanban, Loader2, AlertCircle, Lock, Globe, Users, Plus, type LucideIcon } from "lucide-react"
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value) => setFormData({ ...formData, visibility: value as "private" | "workspace" | "public" })}
                                disabled={isSubmitting}
                            >

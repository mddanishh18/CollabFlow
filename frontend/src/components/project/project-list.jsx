...
/**
 * Project list component with search, sort, and view options
 * @param {Array} projects - Array of project objects
 * @param {string} workspaceId - Parent workspace ID
 * @param {boolean} loading - Loading state
 * @param {function} onEdit - Edit project callback
 * @param {function} onDelete - Delete project callback
 * @param {function} onViewMembers - View members callback
 * @param {function} onCreate - Create project callback
 */

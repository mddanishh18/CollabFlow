...
export default function WorkspaceRedirect() {
    ...
    useEffect(() => {
        ...
        Promise.all([fetchUserWorkspaces(), fetchPendingInvitations()]).catch((err) => {
    ...
    const handleAcceptInvitation = async (token: string) => {
        ...
        try {
            ...
            await Promise.all([fetchUserWorkspaces(), fetchPendingInvitations()])
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-linear-to-br from-background via-background to-muted/20 relative">
                ...
                {hasPendingInvitations && (
                    <Card className="border-primary/20">
                        <CardHeader>
                            ...
                            <CardDescription>You've been invited to join these workspaces</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-3">
            ...
            <CreateWorkspaceDialog open={createDialogOpen} onClose={handleDialogClose} />
        </div>
    )
}
